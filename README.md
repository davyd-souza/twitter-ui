...
<p>This project was made following Rocketseat's Master Class. Where we were introduced to:</p>
<ul>
	<li>React</li>
	<li>Typescript</li>
...
<ul>
	<li>Create a new tweet</li>
	<li>Click on an tweet and be redirected to answer page</li>
	<li>Access and navigate via mobile</li>
</ul>
